...
fileName='1-1_europe_to_north_america_and_mexico_gulf_schedule.pdf'
...
print("file to be uploaded ",completeFile)
...
df=pd.read_excel("1-1_europe_to_north_america_and_mexico_gulf_schedule.xlsx",engine="openpyxl")
...
print(MasterDf)
MasterDf.to_csv("a1.csv",index=False)    
sleep(2)
os.remove('1-1_europe_to_north_america_and_mexico_gulf_schedule.xlsx')
	# driver.quit()
