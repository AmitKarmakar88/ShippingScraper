...
try:
    ...
    URL = 'http://libertygl.com/routeschedtable/view-schedule/far-east-commercial-outbound.html'
    ...
    wget.download(pdf_link,'pdf3.pdf')

    sleep(4)
    df_dataset = tabula.read_pdf('pdf3.pdf',multiple_tables = True,encoding='utf-8',pages='all')
    ...
    MasterDf.to_csv("LGL_third_pdf.csv",index=False)
    
    sleep(2)
    #send_email('LGL_third_pdf.csv')#send mail
    # #print("Email sent LGL_third_pdf.....")
    # sleep(10)#after 5 second remove file
    # #os.remove('LGL_third_pdf.csv')
    # #print("File remove LGL_third_pdf")

except Exception as e:
    #print(e)
    #print("ERROR file not send")
    pass
