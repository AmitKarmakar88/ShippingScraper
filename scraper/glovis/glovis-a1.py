...
try:
	...
	link = [a['href'] for a in contentTable.find_all('a', href=True)][2:][0]
	print("links=",link)
	#========================================================================================= 
		
	url=link   
	# url = 'https://www.stenaglovis.com/app/uploads/2020/08/Sailing-Schedule-Stena-Glovis-CW-3536_Fareast.pdf'
	...
	df=pd.read_excel("a1.xlsx",engine="openpyxl")
